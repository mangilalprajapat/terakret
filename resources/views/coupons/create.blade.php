                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="maximum_usage" type="number" class="form-control @error('maximum_usage') is-invalid @enderror" name="maximum_usage" value="1" placeholder="Enter maximum coupon usage" >
                                        <div class="help-block with-errors" ></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="user_limit" type="number" class="form-control @error('user_limit') is-invalid @enderror" name="user_limit" value="1" placeholder="Enter coupon user limit" >
                                        <div class="help-block with-errors" ></div>
