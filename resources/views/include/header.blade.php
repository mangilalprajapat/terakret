        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="top-menu d-flex align-items-center">
                        ...
                        <div class="notifications-wrap">
                            <a href="#" class="media">
                                ...
                                <span class="media-body">
                                    <span class="heading-font-family media-heading">{{ __('Terakret')}}</span> 
                                    <span class="media-content">{{ __('Project ready')}}</span>
                                </span>
                            </a>
                        </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right menu-grid d-none" aria-labelledby="menuDropdown">
                ...
                <button type="button" class="nav-link ml-10" id="apps_modal_btn" data-toggle="modal" data-target="#appsModal_None"><i class="ik ik-grid"></i></button>
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="{{ asset('img/user4.png')}}" alt=""></a>
